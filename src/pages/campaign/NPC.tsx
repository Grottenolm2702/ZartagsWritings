      ...
      <main>
        ...
        <div className="content-header">
          ...
          <div className="content-header-item">
            ...
            <span className="value">Caotic Neutral</span>
          </div>
        </div>
          ...
          <div className="items-masonry">
            <div className="item-card">
              ...
              <p>
                ...
                new magical tools—even if they ask him to stop.He lives in a
                magical hut in the woods, which is filled to the brim with
                mostly useless magical items. However, he is rarely home, as he
                spends most of his time traveling the world and visiting every
                convention he can find.
              </p>
            </div>
            <div className="item-card">
              <h2>Story Points</h2>
