      ...
      <main>
        ...
        <section className="element-section" data-category="Pcs">
          ...
          <ul className="element-list">
            <li>
              <a href="/capaign1/pc">Melissa - Fighter - Tiefling</a>
            </li>
            <li>
              <a href="#">Ronny - Garten - Zwerg</a>
            </li>
            <li>
              <a href="#">Human - Male - Fighter</a>
            </li>
          </ul>
        </section>
        ...
        <section className="element-section" data-category="Mi">
          ...
          <ul className="element-list">
            <li>
              <a href="/capaign1/magicitem">Das Buch</a>
            </li>
            <li>
              <a href="#">Warschip</a>
            </li>
        ...
        <section className="element-section" data-category="Loc">
          ...
          <ul className="element-list">
            ...
            <li>
              <a href="/capaign1/location">Das Herrenhaus</a>
            </li>
            <li>
              <a href="#">Der Brunnen</a>
            </li>
          </ul>
        </section>
      </main>
